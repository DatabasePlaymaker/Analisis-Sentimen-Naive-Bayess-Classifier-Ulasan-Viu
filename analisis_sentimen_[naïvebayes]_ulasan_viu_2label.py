# -*- coding: utf-8 -*-
"""Analisis Sentimen - [NaïveBayes] - Ulasan Viu - 2Label.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1St-JEpgSgJfdmCr-G1seiV9qTiXSm-5t
...
more_stop_words = ["dengan", "tidak", "aku", "engkau", "kamu", "beliau", "kalian", "kita", "sini", "situ", "sana",
                   ...
                   "cukup", "lah", "tah", "yang", "nya", "untuk", "dan", "di", "ada", "saya", "ini", "banyak", "itu"]
...
df['steamming'].to_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_steamming_Viu_1_5K.csv', index = False)
...
df_values.to_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_terjemahan_Viu_1_5K_1.csv')
